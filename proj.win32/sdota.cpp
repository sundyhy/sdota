    ...
    int       nCmdShow)
{
    ...
    return SdotaPlayer::createAndRun();
}

int SdotaPlayer::createAndRun(void)
{
    SdotaPlayer *host = SdotaPlayer::sharedInstance();
    int ret = host->run();
    SdotaPlayer::purgeSharedInstance();
    return ret;
}

SdotaPlayer *SdotaPlayer::s_sharedInstance = NULL;

SdotaPlayer *SdotaPlayer::sharedInstance(void)
{
    if (!s_sharedInstance)
    {
        s_sharedInstance = new SdotaPlayer();
    }
    return s_sharedInstance;
}

void SdotaPlayer::purgeSharedInstance(void)
{
    if (s_sharedInstance)
    {
...
int SdotaPlayer::run(void)
{
    ...
    do
    {
        ...
        SetWindowTextA(m_hwnd, "sdota-player");
...
void SdotaPlayer::loadProjectConfig(void)
{
    vector<string> args;
...
void SdotaPlayer::createViewMenu(void)
{
...
void SdotaPlayer::updateMenu(void)
{
    HMENU menu = GetMenu(m_hwnd);
    HMENU viewMenu = GetSubMenu(menu, 1);
...
void SdotaPlayer::updateWindowTitle(void)
{
}

void SdotaPlayer::relaunch(void)
{
...
void SdotaPlayer::writeDebugLog(const char *log)
{
...
// menu callback
void SdotaPlayer::onFileOpenProject(void)
{
...
void SdotaPlayer::onFileCreateProjectShortcut(void)
{
    ...
    if (SUCCEEDED(hres))
    {
        ...
        psl->SetDescription(L"SdotaPlayer");
...
void SdotaPlayer::onFileProjectConfig(void)
{
...
void SdotaPlayer::onFileRelaunch(void)
{
    relaunch();
}

void SdotaPlayer::onFileExit(void)
{
    DestroyWindow(m_hwnd);
}

void SdotaPlayer::onViewChangeFrameSize(int viewMenuID)
{
...
void SdotaPlayer::onViewChangeOrientation(int viewMenuID)
{
    bool isLandscape = m_project.isLandscapeFrame();
...
void SdotaPlayer::onViewChangeZoom(int scaleMode)
{
    float scale = 1.0f;
...
void SdotaPlayer::onHelpAbout(void)
{
    DialogBox(GetModuleHandle(NULL), MAKEINTRESOURCE(IDD_ABOUTBOX), m_hwnd, AboutDialogCallback);
}

// windows callback
LRESULT SdotaPlayer::WindowProc(UINT message, WPARAM wParam, LPARAM lParam, BOOL* pProcessed)
{
    int wmId, wmEvent;
    SdotaPlayer *host = SdotaPlayer::sharedInstance();
...
INT_PTR CALLBACK SdotaPlayer::AboutDialogCallback(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
